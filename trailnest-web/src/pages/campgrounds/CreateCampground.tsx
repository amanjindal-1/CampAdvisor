...
export default function CreateCampground() {
	...
	const mutation = useMutation({
		...
		onSuccess: (res) => {
			...
			navigate({
				to: `/campgrounds/${res.data.data.slug}`,
			});
		},
		onError: () => toast.error("Failed to create campground"),
	});
	...
	return (
		<div className="max-w-2xl mx-auto px-4 sm:px-6 py-10">
			...
			<Card>
				<CardHeader>
					<CardTitle className="text-2xl">Add a campground</CardTitle>
				</CardHeader>
				<CardContent>
					<Form {...form}>
						<form
						...
						>
							...
							>
								...
								{mutation.isPending ? "Creating…" : "Create campground"}
							</Button>
						</form>
					</Form>
				</CardContent>
